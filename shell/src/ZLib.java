...
public class ZLib {
            ...
            return new ZInst(this) {
                public String query(String q) {
                    try {
                        ...
                        cr.query(q);
                        System.setOut(ps);
                        cr.process(zbug.bugster.Auth.ia);
            ...
            return new ZInst(this) {
                public String invoke() {
                    ...
                    for (String s : ss) {
                        ...
                        qp.setToken(token());
                        qp.process(zbug.bugster.Auth.ia);
    ...
    static ZHolder _cat =  new ZHolder() {
        ...
        public ZInst create() {
            return new ZInst(this) {
                public String invoke() {
                    return ZUtil.read_file(getarg(0));
                }
            };
        }
    };
            ...
            return new ZInst(this) {
                public String invoke() {
                    try {
                        ...
                        return "" + ZUtil.write_file(getarg(0), parent.invoke());
                    } catch (Exception e) {
                        Zx.err(e);
    ...
    static String token() {
        return zbug.bugster.Auth.ac().getToken();
    }
                ...
                public String invoke() {
                    try {
                        ...
                        if (user.equals(ZBug.user) && ZBug.enc != null) {
                            ZBug.token = zbug.bugster.Auth.login(ZBug.user,ZBug.enc, true);
                        } else {
                            ZBug.out.print("["+user + "] password: ");
                            pass = ZBug.reader().readLine(new Character('*'));
                            if ((pass == null) || (user == null)) throw new Zx("invalid username or password. (" + user + "," + pass + ")");
                            ZBug.token = zbug.bugster.Auth.login(user, pass, false);
                            ZBug.user = user;
                        }
            ...
            return new ZInst(this) {
                ...
                public String invoke() {
                    try {
                        ...
                        ZUtil.write_file(ZBug.home + "/.bugster", enc);
